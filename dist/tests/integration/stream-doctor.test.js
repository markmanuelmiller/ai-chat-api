...
const stream_doctor_graph_1 = require("../../application/ai/graphs/stream-doctor-graph");
describe('StreamDoctorGraph Integration', () => {
    let streamDoctorGraph;
    let mockLLM;
    beforeAll(() => {
        // Create a mock LLM for testing
        mockLLM = new anthropic_1.ChatAnthropic({
            model: "claude-3-sonnet-20240229",
            temperature: 0,
            maxTokens: 1000,
        });
        streamDoctorGraph = new stream_doctor_graph_1.StreamDoctorGraph(mockLLM);
    });
    it('should create StreamDoctorGraph instance', () => {
        expect(streamDoctorGraph).toBeDefined();
        expect(streamDoctorGraph).toBeInstanceOf(stream_doctor_graph_1.StreamDoctorGraph);
    });
...
//# sourceMappingURL=stream-doctor.test.js.map